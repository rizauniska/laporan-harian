<?php
// absensi_pengaturan.php – Pengaturan Jadwal, Rotasi & Periode | AdminLTE 4
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-header bg-white py-2 d-flex justify-content-between align-items-center">
            <h6 class="card-title mb-0 fw-bold"><i class="bi bi-calendar3 text-primary me-2"></i>Manajemen Periode Kerja</h6>
          ...
          <div class="card-body p-0 table-responsive">
            <table class="table table-hover align-middle mb-0">
              ...
              <tbody id="tbodyPeriods">
                <tr><td colspan="6" class="text-center py-3 text-muted">Memuat periode...</td></tr>
              </tbody>
            </table>
          </div>
        </div>
...
async function loadPeriods() {
  const tbody = document.getElementById('tbodyPeriods');
  try {
      ...
      html += `
        <tr>
          ...
          <td class="text-center">
            ${activateBtn}
            <button class="btn btn-xs btn-outline-danger py-0 px-2" onclick="deletePeriod(${p.id})"><i class="bi bi-trash"></i></button>
          </td>
        </tr>
      `;
    });
    tbody.innerHTML = html || '<tr><td colspan="6" class="text-center py-3 text-muted">Belum ada periode.</td></tr>';
  } catch (err) {
