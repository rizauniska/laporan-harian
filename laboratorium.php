<?php
// laboratorium.php – Detail Total Laboratorium dengan DataTables | AdminLTE 4
...
<head>
  ...
  <title>Total Laboratorium | Kasir Laporan Keuangan</title>
  <meta name="description" content="Laporan detail Total Pendapatan Laboratorium kasir pendaftaran.">
  ...
  <main class="app-main">
    <div class="app-content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3 class="mb-0 fw-bold"><i class="fas fa-flask text-warning me-2"></i>Total Laboratorium</h3>
          </div>
          <div class="col-sm-6 text-end">
            <ol class="breadcrumb float-sm-end mb-0">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Total Laboratorium</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row g-3 mb-4 stat-cards no-print">
          <div class="col-md-4 col-sm-6">
            <div class="card shadow-sm stat-card total-card p-3">
              <div class="d-flex align-items-center gap-3">
                <div class="stat-icon-wrapper stat-icon-yellow"><i class="fas fa-flask"></i></div>
                <div>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card shadow-sm stat-card stat-card-warning p-3">
              <div class="d-flex align-items-center gap-3">
                <div class="stat-icon-wrapper stat-icon-cyan"><i class="bi bi-graph-up"></i></div>
                <div>
                  <div class="text-muted small fw-semibold">Rata-rata / Hari Aktif</div>
                  <div class="fs-5 fw-bold text-info" id="statAvg">Rp 0</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card shadow-sm">
          <div class="card-header d-flex align-items-center justify-content-between py-3">
            <h5 class="card-title mb-0 fw-bold"><i class="bi bi-table text-primary me-2"></i>Rincian Total Laboratorium (DataTables)</h5>
          ...
          <div class="card-body p-3">
            <div class="table-responsive no-print">
              <table class="table table-striped table-bordered table-hover align-middle mb-0" id="labTable" style="width:100%">
                <thead class="table-light">
                  <tr>
                    <th class="text-center" width="50">No</th>
                    <th>Tanggal Laporan</th>
                    <th class="text-center" width="130">Jumlah Item Lab</th>
                    <th class="text-end" width="240">Total Laboratorium</th>
                  </tr>
                </thead>
                ...
                <tfoot class="table-light fw-bold">
                  <tr>
                    ...
                    <td class="text-end text-warning fs-6" id="sumTotalText">Rp 0</td>
                  </tr>
                </tfoot>
              </table>
            </div>
...
async function loadData(start = '', end = '') {
  ...
  try {
    ...
    const tableData = rows.map((r, idx) => [
      ...
      `<span class="badge bg-secondary">${r.item_count || 0} item</span>`,
      `<span class="fw-bold text-warning text-dark">${fmt(r.total_lab)}</span>`
    ]);
    ...
    tbodyPrint.innerHTML = rows.map((r, idx) => `
      <tr>
        ...
        <td style="border:1px solid #000; padding:6px; text-align:center; color:#000;">${r.item_count || 0} item</td>
    ...
    tfootPrint.innerHTML = `
      <tr style="border-top:2.5px solid #000;">
        <td colspan="3" style="border:1px solid #000; padding:6px; text-align:right; font-weight:bold; color:#000;">JUMLAH TOTAL (${count} hari)</td>
  ...
  document.getElementById('btnCetak').addEventListener('click', () => {
    ...
    printView.innerHTML = `
      <div style="text-align:center; border-bottom:2px solid #000; padding-bottom:8px; margin-bottom:14px;">
        <h1 style="font-size:15pt; font-weight:800; text-transform:uppercase; margin:0 0 4px 0; color:#000;">Laporan Total Laboratorium</h1>
      ...
      <table style="width:100%; border-collapse:collapse; font-size:9.5pt; font-family:Arial, sans-serif; border:1.5px solid #000;">
        <thead>
          <tr style="border-bottom:2.5px solid #000; background:#f0f0f0;">
            ...
            <th style="border:1px solid #000; padding:6px; text-align:center; width:120px; color:#000;">Jumlah Item</th>
            <th style="border:1px solid #000; padding:6px; text-align:right; width:220px; color:#000;">Total Lab</th>
          </tr>
        </thead>
