...
<head>
  ...
  <style>
    ...
    #fisio90Table { border-radius: 6px; overflow: hidden; font-size: .875rem; }
    ...
    .stat-card.pasien-card{ border-color: #0f766e; }
    .stat-card.total-card { border-color: #198754; }
    .stat-card.avg-card   { border-color: #0d6efd; }
    ...
    @media print {
      ...
      .app-header, .app-sidebar, .app-footer, .no-print, .filter-area, .stat-cards, .card-tools, .breadcrumb, .app-content-header, .tabulator, #fisio90Table { display: none !important; }
    ...
    <div class="sidebar-wrapper">
      <nav class="mt-2">
        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu">
          ...
          <li class="nav-item"><a href="fisio_90.php" class="nav-link active"><i class="nav-icon fas fa-users"></i><p>Pasien Fisio 90rb</p></a></li>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card shadow-sm stat-card pasien-card p-3">
              <div class="d-flex align-items-center gap-3">
                <div style="width:48px;height:48px;border-radius:10px;background:rgba(15,118,110,.12);display:flex;align-items:center;justify-content:center;font-size:1.4rem;color:#0f766e">
