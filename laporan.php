...
<head>
  ...
  <style>
    ...
    /* ---- Saldo callout ---- */
    .saldo-callout { background: linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%); color: #fff; border-radius: 8px; }
    .saldo-callout .saldo-val { font-size: 1.5rem; font-weight: 800; }
    .saldo-callout .saldo-formula { font-size: .78rem; opacity: .85; }
    ...
    .ts-wrapper { min-height: 31px; }
    .ts-control  { font-size: .875rem; min-height: 31px !important; padding: 3px 8px !important; }
    ...
    @media print {
      ...
      .app-wrapper, .app-header, .app-sidebar, .app-footer, .toast { display: none !important; }
                      ...
                      <div class="card shadow-none border">
                        ...
                        <div class="card-body p-0">
                          <table class="table table-bordered table-sm rekap-table mb-0">
                            <thead><tr><th colspan="2">Detail Laporan</th></tr></thead>
